...
\begin{figure}[htbp]\centering\includegraphics[width=.88\linewidth]{figures/q2_candidates.pdf}\caption{第二检测点的稳健候选区域：浅蓝为三圆公共区域，绿色为名义交会角筛选后的候选区域。第一检测点取圆心，角度误差按实际2度张角绘制。}\end{figure}
